class Debitnote < ActiveRecord::Base
	...
	validates :DirOrigen, length:{maximum: 60}
	...
	validates :GiroRecep, length:{maximum: 40}
	...
	validates :IVANoRet, length:{maximum: 18}
	validates :CredEC, length:{maximum: 18}	
	validates :GmtDep, length:{maximum: 18}
	validates :ValComNeto, length:{maximum: 18}
	validates :ValComExe, length:{maximum: 18}
	validates :ValComIVA, length:{maximum: 18}
	...
	validates :ImpRetOtrMnda, length:{maximum: 3}
	...
	validates :IVANoRetOtrMnd, length:{maximum: 18}
	...
	validates :IndGlobal, length:{maximum: 1}, presence: true
	validates :FolioRef, length:{maximum: 18}, presence: true
	validates :RUTOtr, length:{maximum: 10}
	validates :FchRef, length:{maximum: 10}, presence: true
	validates :CodRef, length:{maximum: 1}, presence: true
	validates :RazonRef,length:{maximum: 90}
	validates :NroLinCom,length:{maximum: 2}, presence: true
	validates :TipoMovim, length:{maximum: 1}, presence: true
	validates :Glosa, length:{maximum: 60}, presence: true
	validates :TasaComision, length:{maximum: 4}
	validates :ValComNeto, length:{maximum: 18}, presence: true
	validates :ValComExe, length:{maximum: 18}, presence: true
	validates :ValComIVA, length:{maximum: 18}
